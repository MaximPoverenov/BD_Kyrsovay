...
class DBManager:
    ...
    def fetch_employer_data(self):
        """
        Метод получает данные о компаниях
        """
        employer_data = []
    ...
    def fetch_vacancy_data(self):
        """
        Метод извлекает данные о вакансиях из таблицы vacancies
        :return: [(vacancy_id, employer_id, name, url, salary_from, salary_to, currency), ...]
        """
        vacancy_data = []
